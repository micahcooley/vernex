"""
Vernex Critic Fine-tuning
Code review, criticism, spotting issues
"""
import torch
...
def train():
    ...
    print(f"Training Critic on: {device}")
    ...
    corpora = [
        {'path': DATA_DIR / "critic_corpus.txt", 'weight': 20},
    ...
    print("Starting Critic Fine-tuning...")
    for epoch in range(5):
        ...
        for batch_idx, (x, y) in enumerate(loader):
            ...
            if batch_idx % 100 == 0:
                tmp_path = MODEL_DIR / "vernex_critic_latest.pt.tmp"
                final_path = MODEL_DIR / "vernex_critic_latest.pt"
    ...
    torch.save(model.state_dict(), str(MODEL_DIR / "vernex_critic_final.pt"))
